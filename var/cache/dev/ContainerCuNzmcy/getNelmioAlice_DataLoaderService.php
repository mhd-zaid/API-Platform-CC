...
class getNelmioAlice_DataLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $g = new \Nelmio\Alice\PropertyAccess\StdPropertyAccessor(($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)));

        $h = new \Nelmio\Alice\Generator\Resolver\Value\ValueResolverRegistry([new \Nelmio\Alice\Generator\Resolver\Value\Chainable\ArrayValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\DynamicArrayValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\EvaluatedValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FunctionCallArgumentResolver(new \Nelmio\Alice\Generator\Resolver\Value\Chainable\PhpFunctionCallValueResolver($container->parameters['nelmio_alice.functions_blacklist'], new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FakerFunctionCallValueResolver(($container->services['Faker\\Generator'] ?? $container->load('getGeneratorService'))))), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FixturePropertyReferenceResolver($g), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FixtureMethodCallReferenceResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\UnresolvedFixtureReferenceIdResolver(new \Nelmio\Alice\Generator\Resolver\Value\Chainable\SelfFixtureReferenceResolver(new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FixtureReferenceResolver())), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FixtureWildcardReferenceResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\ListValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\OptionalValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\ParameterValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\UniqueValueResolver(new \Nelmio\Alice\Generator\Resolver\UniqueValuesPool(), NULL, 150), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\ValueForCurrentValueResolver(), new \Nelmio\Alice\Generator\Resolver\Value\Chainable\VariableValueResolver()]);
